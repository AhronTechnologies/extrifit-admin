  ...
  (
    ...
    return (
      <div className={className} {...containerProps}>
        ...
        <div
          className={clsx(
            "w-full flex flex-col focus-within:shadow-input focus-within:border-orange-60 px-small py-xsmall bg-grey-5 border border-grey-20 rounded-rounded",
            {
        ...
        >
          <textarea
            className={clsx(
              ...
              "w-full remove-number-spinner leading-base text-grey-90 font-normal caret-orange-60 placeholder-grey-40",
