...
const PriceFormInput = ({
  ...
  return (
    <div>
      <div
        className={clsx(
          "w-full flex items-center bg-grey-5 border border-gray-20 px-small py-xsmall rounded-rounded h-10 focus-within:shadow-input focus-within:border-orange-60",
          {
      ...
      >
        ...
        <AmountField
          ...
          className="bg-transparent outline-none outline-0 w-full remove-number-spinner leading-base text-grey-90 font-normal caret-orange-60 placeholder-grey-40 text-right"
        />
      </div>
